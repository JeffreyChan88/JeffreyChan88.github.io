...
window.requestAnimFrame = (function() {
	...
	function(callback) {
		window.setTimeout(callback, 2 / 20);
	};
})();
...
var platforms = [],
	...
	player, platformCount = 1009,
	position = 0,
	gravity = 0.06,
	animloop,
	flag = 0,
	menuloop, broken = 0,
	dir, score = 999999999999, firstRun = true;
...
function Platform() {
	...
	if (score >= 5000) this.types = [4, 4, 4, 3, 4, 4, 4, 4];
