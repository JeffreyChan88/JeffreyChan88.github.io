...
function cave() {
  window.location="http://JeffreyChan88.github.io/TSIOF/Battles/bear/index.html";
}

function fightwitch() {
  window.location="http://JeffreyChan88.github.io/TSIOF/Battles/witch/index.html";
}

function fightshadowman() {
  window.location="http://JeffreyChan88.github.io/TSIOF/Battles/shadowman/index.html";
}